...
import simulated_trading.engine as engine_module  # noqa: E402
from simulated_trading.engine import OrderRequest, PaperTradingEngine  # noqa: E402
from simulated_trading.market_data import Quote  # noqa: E402
...
def run_service_cli_checks() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        service_cmd = [
            sys.executable,
            str(SCRIPT_DIR / "simulated_trading_service.py"),
            "--host",
            "127.0.0.1",
            "--port",
            str(port),
        ...
        try:
            ...
            cli = [sys.executable, str(SCRIPT_DIR / "simulated_trading_cli.py"), "--base-url", base]
