...
from simulated_trading_runtime import DEFAULT_HOST, DEFAULT_PORT
...
def request_json(base_url: str, method: str, path: str, payload: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"{base_url}: {exc}. "
            "Try starting it with: python3 scripts/simulated_trading_ctl.py start"
        ) from exc
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Paper trading CLI for simulated_trading skill")
